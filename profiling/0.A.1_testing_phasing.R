...
#ERROR: dependencies ‘rhdf5’, ‘inline’ are not available for package ‘tasselr’
load_all("~/bin/ProgenyArray")

# cache files
tassel_file <- "largedata/cj_data.Rdata"
...
sl <- read.table("data/refgen2-lengths.txt", col.names=c("chrom", "length"),
